...
class Admin extends CI_Controller { 
    ...
    /************************BROOOOOOOOOOOOOOOOOO ON EST DONC LA */
    
    
    /***********  The function below manages new admin ***********************/
    function extension_fullscreen ($param1 = null, $param2 = null, $param3 = null){

        

        $page_data['page_name']     = 'extension_fullscreen';
        $page_data['page_title']    = get_phrase('extension_fullscreen');
        $this->load->view('backend/index', $page_data);
    }
