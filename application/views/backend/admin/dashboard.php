...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->	  
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title"><?php echo get_phrase('DASHBOARD'); ?></h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                <li class="breadcrumb-item" aria-current="page"><?php echo get_phrase('admin'); ?></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo get_phrase('DASHBOARD'); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    text-align: center;
    margin-bottom: 20px; /* pour ajouter de l'espace en dessous de chaque élément */
}

.r-icon-stats i {
    background-color: #f5f5f5; /* couleur de fond pour l'icône */
    border-radius: 50%; /* pour rendre le contour rond */
    padding: 20px; /* pour ajouter de l'espace autour de l'icône */
    margin-bottom: 10px; /* pour ajouter de l'espace entre l'icône et le texte */
    font-size: 24px; /* ajustez selon vos besoins */
}

.bodystate {
    margin-top: 10px; /* pour ajouter de l'espace entre l'icône et le texte */
}
