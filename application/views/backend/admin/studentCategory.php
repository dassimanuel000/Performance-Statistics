    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title"><?php echo get_phrase('Student Categories'); ?></h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                <li class="breadcrumb-item" aria-current="page"><?php echo get_phrase('admin'); ?></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo get_phrase('Student Categories'); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                        ...
                                        <div class="panel-body table-responsive">
                                            ...
                                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $counter = 1;
                                                    $categories =  $this->db->get('student_category')->result_array();
                                                    foreach ($categories as $key => $category) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/studentcategoryEdit/<?php echo $category['student_category_id']; ?>');" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit" style="color:white"></i></a>
