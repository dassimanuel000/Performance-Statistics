    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('update_expense'); ?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <select name="expense_category_id" class="form-control" required>
                                    ...
                                    ?>
                                        <option value="<?php echo $row2['expense_category_id']; ?>" <?php if ($row['expense_category_id'] == $row2['expense_category_id'])
                                                                                                        echo 'selected'; ?>>
                                            <?php echo $row2['name']; ?>
                                        </option>
                                    <?php endforeach; ?>
