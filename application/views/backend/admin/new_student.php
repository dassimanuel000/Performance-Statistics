						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<label for="formFile" class="form-label">Default Image</label>
									<input type='file' id="formFile" name="userfile" onChange="readURL(this);" style="color:red">
									<img id="blah" src="<?php echo base_url(); ?>uploads/default_avatar.jpg" alt="your image" height="150" width="150" />
