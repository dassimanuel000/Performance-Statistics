...
--
-- Hôte : localhost
-- Généré le : ven. 08 sep. 2023 à 18:35
...
--
-- Structure de la table `academic_syllabus`
--
...
(1, 'Administrator', 'admin@admin.com', '07133445656', 'b9c846cd70fe17facd4e8d6e890a1f505faeb323', '1', '1'),
...
--
-- Structure de la table `circular`
--
...
--
-- Déchargement des données de la table `circular`
--
...
--
-- Déchargement des données de la table `class_routine`
--
...
--
-- Déchargement des données de la table `dormitory`
--
...
--
-- Structure de la table `enquiry_category`
--
...
--
-- Déchargement des données de la table `enquiry_category`
--
...
--
-- Déchargement des données de la table `hostel`
--
...
--
-- Déchargement des données de la table `hostel_category`
--
...
--
-- Déchargement des données de la table `hostel_room`
--
...
--
-- Déchargement des données de la table `hrm`
--
...
(1, 'system_name', 'Gesstion Ecole'),
(2, 'system_title', 'Administrateur Ecole'),
...
--
-- Structure de la table `social_category`
--
...
--
-- Déchargement des données de la table `social_category`
--
...
--
-- Déchargement des données de la table `transport_route`
--
...
--
-- Index pour la table `academic_syllabus`
--
...
--
-- Index pour la table `class_routine`
--
...
--
-- Index pour la table `enquiry_category`
--
...
--
-- Index pour la table `hostel_category`
--
ALTER TABLE `hostel_category`
  ADD PRIMARY KEY (`hostel_category_id`);

--
-- Index pour la table `hostel_room`
--
...
--
-- Index pour la table `social_category`
--
...
--
-- Index pour la table `student_category`
--
...
--
-- Index pour la table `transport_route`
--
ALTER TABLE `transport_route`
  ADD PRIMARY KEY (`transport_route_id`);

--
-- Index pour la table `vacancy`
--
ALTER TABLE `vacancy`
...
--
-- AUTO_INCREMENT pour la table `academic_syllabus`
--
ALTER TABLE `academic_syllabus`
...
--
-- AUTO_INCREMENT pour la table `circular`
--
ALTER TABLE `circular`
...
--
-- AUTO_INCREMENT pour la table `class_routine`
--
ALTER TABLE `class_routine`
...
--
-- AUTO_INCREMENT pour la table `dormitory`
--
ALTER TABLE `dormitory`
...
--
-- AUTO_INCREMENT pour la table `enquiry_category`
--
ALTER TABLE `enquiry_category`
...
--
-- AUTO_INCREMENT pour la table `hostel_category`
--
ALTER TABLE `hostel_category`
  MODIFY `hostel_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `hostel_room`
--
ALTER TABLE `hostel_room`
...
--
-- AUTO_INCREMENT pour la table `hrm`
--
ALTER TABLE `hrm`
...
--
-- AUTO_INCREMENT pour la table `social_category`
--
ALTER TABLE `social_category`
...
--
-- AUTO_INCREMENT pour la table `student_category`
--
ALTER TABLE `student_category`
...
--
-- AUTO_INCREMENT pour la table `transport_route`
--
ALTER TABLE `transport_route`
  MODIFY `transport_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `vacancy`
--
ALTER TABLE `vacancy`
